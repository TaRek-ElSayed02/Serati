...
website: 'https:
  ...
  const [summary, setSummary] = useState('مطور تطبيقات متكامل بخبرة تزيد عن 5 سنوات في بناء تطبيقات الويب القابلة للتوسع. يمتلك كفاءة عالية في أطر عمل JavaScript الحديثة وتقنيات الحوسبة السحابية.');
