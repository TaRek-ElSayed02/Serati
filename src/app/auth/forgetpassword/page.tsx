            ...
            >
                ...
                <div className="relative z-10 w-full max-w-md">
                    <div className="bg-white/95 rounded-2xl shadow-2xl p-8 border border-white/20 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800 mb-3" style={{ fontFamily: 'cairo' }}>
                            تم إرسال البريد الإلكتروني
                        </h1>
                        <p className="text-gray-600 mb-6" style={{ fontFamily: 'cairo' }}>
                            تم إرسال رمز التحقق (OTP) إلى بريدك الإلكتروني. يرجى التحقق من صندوق الوارد الخاص بك.
                        </p>
                        <a
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full text-left px-4 py-3 pl-12 border-2 ${error ? 'border-red-400' : 'border-gray-200'} rounded-xl focus:border-[#192A3D99] focus:outline-none transition-colors bg-white`}
                                    style={{ direction: 'ltr' }}
                                />
                                <Mail className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
                            </div>
                            {error && <p className="text-red-500 text-xs mt-1 text-right" style={{ fontFamily: 'cairo' }}>{error}</p>}
                        </div>
                        <button
