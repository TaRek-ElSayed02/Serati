      ...
      <div className="relative z-10 w-full max-w-md mt-[-60]">
        <div className="bg-white/95 rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center justify-center gap-2">
                <span className="text-blue-700 text-sm font-medium" style={{ fontFamily: 'cairo' }}>
                  الكود صالح لمدة:
                </span>
              ...
              {countdown === 0 && (
                <p className="text-red-600 text-xs mt-2 font-medium" style={{ fontFamily: 'cairo' }}>
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-gray-700 text-sm font-medium mb-3 text-center" style={{ fontFamily: 'cairo' }}>
                ادخل الكود الخاص بك
              </label>
              ...
              {error && <p className="text-red-500 text-xs mt-1 text-center" style={{ fontFamily: 'cairo' }}>{error}</p>}
            </div>
            ...
            <div className="text-center text-sm">
              ...
              >
                {resendDisabled ? `إعادة إرسال (${formatTime(countdown)})` : 'إعادة إرسال'}
              </button>
            </div>
