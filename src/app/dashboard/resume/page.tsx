...
//     // --- SKILLS FUNCTIONS ---
//     const addSkill = () => {
//         setSkills([...skills, { id: Date.now().toString(), name: '', type: 'technical', level: 'intermediate' }]);
//     };
...
//         try {
//             // 1. حفظ المعلومات الشخصية (usercv) أولاً
...
//             // الحصول على usercvid من الرد
//             const usercvid = userCVData.data?.id || userCVData.id;
//             if (!usercvid) {
//                 throw new Error('لم يتم الحصول على معرف السيرة الذاتية');
//             }

//             setCurrentUsercvId(usercvid);
//             console.log('Usercv ID:', usercvid);

//             // 2. حفظ باقي البيانات باستخدام usercvid
//             const savePromises = [];
...
//                     const token = localStorage.getItem('authToken');
//                     const socialData = {
//                         usercvid: usercvid, // إضافة usercvid
...
//                     console.log('current value:', exp.current);
//                     console.log('worknow value:', expData.worknow);
//                     savePromises.push(
...
//                     console.log('currentlyEnrolled value:', edu.currentlyEnrolled);
//                     console.log('currentlearn value:', eduData.currentlearn);
//                     savePromises.push(
...
//                 if (lang.name) {
//                     const token = localStorage.getItem('authToken');
//                     // تحويل مستوى اللغة إلى القيم المقبولة من API
...
//             // مسح جميع الحقول بعد الحفظ الناجح
//             setPersonalInfo({
//                 fullName: '',
//                 email: '',
//                 phone: '',
...
//             setCustomSections([]);
//             setSocialLinks([]);
//             setCurrentUsercvId(null);

//             // تعطيل زر الحفظ لمدة دقيقتين (120 ثانية)
...
export default function CVCreator() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // الحصول على usercvid الجديد من الرد
            // جرب كل الاحتمالات الممكنة لاستخراج الـ ID
            ...
            // 2. حفظ باقي البيانات باستخدام usercvid الجديد
            const savePromises = [];
